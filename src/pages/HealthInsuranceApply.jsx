          ...
          <Box>
            ...
            <Box sx={{ mb: 3 }}>
              <FormControl component="fieldset" fullWidth>
                ...
                <RadioGroup
                  value={formData.declarationInfo.hasEmploymentIncome}
                  onChange={(e) =>
                    handleInputChange("declarationInfo", "hasEmploymentIncome", e.target.value === "true")
                  }
                >
            ...
            <Box sx={{ mb: 3 }}>
              <FormControl component="fieldset" fullWidth>
                ...
                <RadioGroup
                  value={formData.declarationInfo.hasPension}
                  onChange={(e) => handleInputChange("declarationInfo", "hasPension", e.target.value === "true")}
                >
                  <FormControlLabel value={true} control={<Radio />} label="ПОЛУЧАВАМ" />
                  <FormControlLabel value={false} control={<Radio />} label="НЕ ПОЛУЧАВАМ" />
                </RadioGroup>
            ...
            <Box sx={{ mb: 3 }}>
              <FormControl component="fieldset" fullWidth>
                ...
                <RadioGroup
                  value={formData.declarationInfo.hasOtherIncome}
                  onChange={(e) => handleInputChange("declarationInfo", "hasOtherIncome", e.target.value === "true")}
                >
                  <FormControlLabel value={true} control={<Radio />} label="ПОЛУЧАВАМ" />
                  <FormControlLabel value={false} control={<Radio />} label="НЕ ПОЛУЧАВАМ" />
                </RadioGroup>
            ...
            <Box sx={{ mb: 3 }}>
              <FormControl component="fieldset" fullWidth>
                ...
                <RadioGroup
                  value={formData.declarationInfo.isCurrentlyInsured}
                  onChange={(e) =>
                    handleInputChange("declarationInfo", "isCurrentlyInsured", e.target.value === "true")
                  }
                >
